...
1.	Guarantees Software Quality – Software engineering principles enable the delivery of reliable, high-performing, and bug-free software applications. 
2.	Allows for Scalability – Software that is properly architected can scale with users and system complexity.
3.	Encourages Innovation – Enables businesses to create next-generation technologies such as AI, blockchain, and cloud computing.
4.	Enhances Security – Strong engineering practices safeguard against breaches and secure sensitive data.
5.	Boosts Economic Development – The software industry adds considerably to world economies through employment opportunities and technological developments.
...
1. Planning
•	It defines the project scope, objective and feasibility.
•	Estimates cost, resources, and timeline.
•	It identifies possible risks and mitigation techniques.
2. Requirements Analysis
•	It collects and documents functional as well as nonfunctional requirements.
•	Raises awareness of the needs of stakeholders.
•	It creates Software Requirement Specification (SRS) documents.
3. Design
•	It defines system architecture, user interface and database structures.
•	Creates detailed blueprints for development.
•	It consists of High-Level Design (HLD) and Low Level Design (LLD).
4. Implementation (Coding)
•	Converts design docs and other ideas into the actual software with the use of the programming language.
•	Complies with the coding standards and best practices.
•	Integrates different system components.

5. Testing
•	Fixes defects before the deployment.
•	It has unit testing, integration testing, system testing and user acceptance testing (UAT).
•	It ensures that software is equipped with requirements and works as expected.
6. Deployment
•	Releases the software to the production environment.
•	It can be done in phases, such as beta testing and full rollout.
•	Ensures minimal disruptions during implementation.
7. Maintenance & Support
•	It offers bug fixes and performance improvements as well as updates.
•	It ensures that software will always be secure to meet the changing needs.
•	Addresses user feedback for enhancements.
...
Importance of IDEs:
1.	Increases Productivity – Offers features such as code completion, syntax highlighting, and debugging tools.
2.	Minimises Mistakes — Inbuilt debugging and error detection prevent coding errors.
3.	Improves Code Control – It is compatible with various programming languages, frameworks, and libraries.
4.	It Checks and Simplifies Development: You can edit, compile, and execute all in one environment.
Examples of IDEs:
...
Importance of VCS:
1.	Enables Collaboration – Several engineers can contribute to the same codebase without conflicts.
2.	Tracks Changes – Keeps a record of edits and rolls back to previous versions.
3.	Supports Branching and Merging — Developers can independently work on features and then merge them into the main project.
4.	Improves Code Protection – Gives backup & prevents code loss.
Examples of VCS:
...
Importance:
•	Detects the bugs as early in the development phase, hence avoiding the cost involved in debugging.
•	Verifies that each component works correctly in isolation before being integrated.
•	It helps ensure the quality and stability of the code, especially when updating existing code.
...
Importance:
•	Locates interface defects between modules.
•	Ensures smooth messaging between parts of the software.
•	Solves problems that arise when independent modules are combined.
3.	System Testing
...
Importance:
•	Checks that the software is working as designed in its full-sized version.
•	Map system-wide problems like performance bottlenecks or security weaknesses.
•	Verifies that the application is suitable for its environment and requirements, including hardware and software dependencies.
...
1.	More Specific – The new prompt is better than the one it replaces, as it isn’t asking about "technology" in general but rather "artificial intelligence in healthcare."
2.	Clearly Defined Scope – The AI will be directed to balance out the response with benefits and challenges.
3.	Concise and Precise – This removes ambiguity because the AI can generate a tangible and structured response.
